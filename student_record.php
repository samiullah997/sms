		...
		<div class="row row-cols-1 row-cols-md-2 g-2">
			<div class="col" >
				<a style="text-decoration: none;"
					href="student_admission_form.php">
					<div class="card"
			...
			<div class="col" >
				<a style="text-decoration: none;"
					...
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Student Miscellaneous Records</h5>
						</div>
					</div>
				</a>
			</div>
			...
			<div class="col" >
				<a style="text-decoration: none;"
					href="student_fee_class_record.php">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Student Fee Records</h5>
						</div>
					</div>
				</a>
			</div>		

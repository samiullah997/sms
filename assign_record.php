...
$null="";
 $all_vehicles = mysqli_query($con,"select * from driver_details where check_out_date = '$null' order by id ");
        ...
        <div class="container text-center "
			...
			<card class="card">
					...
					<div class="row  card-header">
						...
						<div class="col-sm-12 "><h3 >Check Out Records</h3></div>
				</div>
                ...
                <?php while($row = mysqli_fetch_array($all_vehicles)) {?>
					<tr >
						...
						<td >  <a href=""	data-bs-toggle="modal" data-bs-target="#checkoutDriver"
                        class="badge bg-primary rounded-pill" onclick="checkOutDriver('<?php echo $row['id'];?>',
                        '<?php echo $row['name'];?>','<?php echo $row['v_name'];?>',
            ...
            <!-- Add Check Out To Driver Modal -->
        <div class="modal fade" id="checkoutDriver" tabindex="-1"
									...
									<form class="row g-3" action="#" method="POST" >
										...
										<div class="col-md-6">
											<label for="inputEmail4" class="form-label">
												Id</label> <input name="id" readonly id="id" required type="text"
                                        ...
                                        <div class="col-md-6">
											<label for="inputPassword4" class="form-label">Driver Name
												 </label> <input name="d_name" readonly required type="text"
												class="form-control" id="d_name">
										</div>

										

										<div class="col-md-6">
											<label for="inputDepartment" class="form-label">Check Out Date </label>
                                             <input name="date" required type="date"
												class="form-control" id="inputPassword4">
										</div>

										<div class="col-12 text-center">
											<button type="submit" name="checkout_driver_submit" class="btn btn-outline-primary">Check Out</button>
										</div>
									</form>
								</div>
							</div>
						...
						<div class="card">
							...
							<div class="card-body">
									...
									<form class="row g-3" action="#" method="POST" >
										...
										<div class="col-12 text-center">
											<button type="submit" name="seat_issued_submit" class="btn btn-outline-primary">Withdraw Student</button>
										</div>
									</form>
								</div>
							</div>

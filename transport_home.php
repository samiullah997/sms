...
<nav
	...
	<div class="content card-body">
		...
		<div class="row row-cols-1 row-cols-md-2 g-2">
            ...
            <div class="col" >
				<a style="text-decoration: none;"
					href="issued_seat_record.php">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Issued Seats Records</h5>
			...
			<div class="col" >
				<a style="text-decoration: none;"
					href="checkout_seat_record.php">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Total Checkout Seats Records</h5>

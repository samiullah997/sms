	...
	<div>
        ...
        <div class="col" >
				<a style="text-decoration: none;"
					href="fee_record.php?class=Nursery">
					<div class="card"
            ...
            <div class="col" >
				<a style="text-decoration: none;"
					href="fee_record.php?class=Prep">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Class Prep</h5>
			...
			<div class="col" >
				<a style="text-decoration: none;"
					href="fee_record.php?class=Three">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Class Three</h5>
			...
			<div class="col" >
				<a style="text-decoration: none;"
					href="fee_record.php?class=Four">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Class Four</h5>
			...
			<div class="col" >
				<a style="text-decoration: none;"
					href="fee_record.php?class=Five">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Class Five</h5>
			...
			<div class="col" >
				<a style="text-decoration: none;"
					href="fee_record.php?class=Sixth">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Class Sixth</h5>
            ...
            <div class="col" >
				<a style="text-decoration: none;"
					href="fee_record.php?class=Seventh">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Class Seventh</h5>
			...
			<div class="col" >
				<a style="text-decoration: none;"
					href="fee_record.php?class=Eigth">
					<div class="card"
						style="background-color: blue; border-radius: 5%;">
						<div class="card-body text-center text-white mt-5 mb-5">
							<h5>Class Eight</h5>
